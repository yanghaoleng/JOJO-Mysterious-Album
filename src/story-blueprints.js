...
export const SCENES = [
  {
    ...
    npc: { name: '折角婆婆', mark: '折', entrance: 'door', voice: 'moss' },
    entranceLine: '一扇折纸小门吱呀打开，折角婆婆抱着一只大贝壳走了出来。',
    dialogue: '码头不是没有声音。它只是把最小的声音漏掉了。你愿意先听哪一边？',
    choices: [
      { id: 'water', label: '先听水下面', voiceHints: ['水下', '水里', '码头下面', '听水'], result: '贝壳里传来一艘小船轻轻敲码头的声音。', trait: 'listen' },
      { id: 'pet', label: '先听伙伴的脚步', voiceHints: ['伙伴', '小宠物', '脚步', '听它'], result: '小宠物的脚步停了一下。它正努力告诉你，水下面有人。', trait: 'together' },
      { id: 'call', label: '大声问“谁在那里”', voiceHints: ['大声问', '喊一声', '谁在那里', '叫它'], result: '回声跑了一圈，最后指向码头下面。你的声音也帮忙找到了方向。', trait: 'bold' },
    ],
  ...
  },
  {
    ...
    npc: { name: '草籽邮差', mark: '籽', entrance: 'grass', voice: 'sprout' },
    entranceLine: '草堆先打了个喷嚏，一顶种子帽从里面慢慢升起来。',
    dialogue: '我有许多话想寄出去，可它们一离开草坡就散开。你觉得该怎样把它们带远？',
    choices: [
      { id: 'tie', label: '把话打成小结', voiceHints: ['打结', '小结', '系起来', '绑起来'], result: '每听完一句，你就在星线上打一个松松的小结。', trait: 'make' },
      { id: 'repeat', label: '和它一起慢慢重复', voiceHints: ['重复', '再说一遍', '一起说', '慢慢说'], result: '两个人说过的话不再容易被风吹散。', trait: 'together' },
      { id: 'draw', label: '把听见的画下来', voiceHints: ['画下来', '画画', '变成图', '画声音'], result: '草籽邮差第一次知道，声音也可以长成图画。', trait: 'imagine' },
    ],
    reward: 'starThread',
  ...
  },
  {
    ...
    npc: { name: '箱箱', mark: '箱', entrance: 'box', voice: 'bubble' },
    entranceLine: '路边木箱的锁扣啪地弹开，箱箱先伸出一双鞋，才想起把脑袋也探出来。',
    dialogue: '这封问候没有写名字。是继续留在箱子里，还是带它去找一个正在等待的人？',
    choices: [
      { id: 'carry', label: '带着它去问路', voiceHints: ['带着信', '去问路', '继续走', '找收件人'], result: '你没有替信决定收件人，只答应带它继续走。', trait: 'care' },
      { id: 'open', label: '先问箱箱能不能打开', voiceHints: ['先问', '能不能打开', '打开看看', '问箱箱'], result: '箱箱点点头。你们只读到一句“我还在这里”，就重新封好。', trait: 'ask' },
      { id: 'leave', label: '在这里等收件人回来', voiceHints: ['在这里等', '等回来', '留下来', '等等看'], result: '等了一会儿，你听见远处的钟声。也许那就是线索。', trait: 'patient' },
    ],
  ...
  },
  {
    ...
    npc: { name: '慢钟先生', mark: '慢', entrance: 'reflection', voice: 'moss' },
    entranceLine: '水盆里的月亮晃了晃，慢钟先生从倒影里跨出来，鞋尖还挂着一点银光。',
    dialogue: '我等的不是一封写着答案的信。我只想知道，沉默的时候还有没有朋友在路上。',
    choices: [
      { id: 'hand', label: '把问候交给他', voiceHints: ['交给他', '递给他', '把信给他', '送问候'], result: '信封一碰到他的手，整座邮局都响起很轻的滴答声。', trait: 'deliver' },
      { id: 'pet-deliver', label: '请小宠物来递信', voiceHints: ['宠物递', '伙伴送', '让它交', '请小宠物'], result: '小宠物认真说出收件人的名字。它的声音比刚醒来时更稳了。', trait: 'together' },
      { id: 'say', label: '再加一句“我们来了”', voiceHints: ['我们来了', '加一句', '告诉他来了', '说句话'], result: '那句新问候没有盖住旧的，而是安静地落在旁边。', trait: 'bold' },
    ],
  ...
  },
  {
    ...
    npc: { name: '无声影', mark: '影', entrance: 'curtain', voice: 'star' },
    entranceLine: '灯塔的旧帘子鼓了三次，一团没有嘴巴的影子从后面滑出来。',
    dialogue: '我不是偷走声音的人。我只是怕一开口，就没有人愿意听完。你们还要点亮这里吗？',
    choices: [
      { id: 'listen', label: '先用听风贝听它说完', voiceHints: ['听它说完', '听风贝', '先听', '不打断'], result: '听风贝没有催促。无声影慢慢说完了藏了很久的担心。', trait: 'listen' },
      { id: 'connect', label: '用星线团连起大家', voiceHints: ['星线团', '连起来', '连接大家', '用线'], result: '星线没有捆住谁，只在每个人之间留出刚好的距离。', trait: 'make' },
      { id: 'invite', label: '请它和我们一起点灯', voiceHints: ['一起点灯', '邀请它', '一起帮忙', '留下它'], result: '你没有赶走无声影，而是给它留了一个能帮忙的位置。', trait: 'care' },
    ],
    reward: null,
  ...
  },
  {
    ...
    npc: { name: '回声群', mark: '声', entrance: 'lantern', voice: 'bubble' },
    entranceLine: '灯塔种子裂开一道暖光，许多小小的回声从灯罩里游了出来。',
    dialogue: '最后一束光该照向哪里？你的选择会写进这本图鉴。',
    choices: [
      { id: 'home', label: '照向正在回家的声音', voiceHints: ['回家的声音', '照回家', '旧回声', '回到原来'], result: '每一段回声都找到了原来那句话，没有谁被落下。', trait: 'care' },
      { id: 'new', label: '照向还没说出口的话', voiceHints: ['没说出口', '新的声音', '还没说', '等它们准备'], result: '海面多出许多安静的小路，等新的声音准备好再出发。', trait: 'patient' },
      { id: 'both', label: '让灯塔慢慢转一圈', voiceHints: ['转一圈', '两边都照', '全部照亮', '都要'], result: '旧回声和新声音轮流被照亮，灯塔不替任何一边着急。', trait: 'together' },
    ],
