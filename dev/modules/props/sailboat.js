// 帆船: independent prefab using the shared material and geometry toolkit.
export function build({THREE,group,part,moving,beam,color,cream,wood,gold,ink}) {
  ...
  part("ball",wood,[0,.3,0],[1,.3,.45]);beam([0,.4,0],[0,1.9,0],.055,wood);part("cone",cream,[.25,1.2,0],[.65,1.3,.05]);
