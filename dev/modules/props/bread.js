// 面包: independent prefab using the shared material and geometry toolkit.
export function build({THREE,group,part,moving,beam,color,cream,wood,gold,ink}) {
  ...
  part("ball","#c99760",[0,.35,0],[.9,.35,.45]);for(let i=-1;i<=1;i++)part("box",cream,[i*.4,.66,0],[.07,.02,.45]);
