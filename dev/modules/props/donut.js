// 甜甜圈: independent prefab using the shared material and geometry toolkit.
export function build({THREE,group,part,moving,beam,color,cream,wood,gold,ink}) {
  ...
  part("ring",wood,[0,.24,0],[.6,.6,2]).rotation.x=Math.PI/2;part("ring","#d899aa",[0,.3,0],[.59,.59,1.6]).rotation.x=Math.PI/2;
