// 风筝: independent prefab using the shared material and geometry toolkit.
export function build({THREE,group,part,moving,beam,color,cream,wood,gold,ink}) {
  ...
  part("star",color,[0,1,0],[.65,.85,.06]);beam([0,.15,0],[0,1.85,0],.025,wood);beam([-.65,1,0],[.65,1,0],.025,wood);
