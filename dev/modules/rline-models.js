...
export function buildRlineModel(k, word) {
  ...
  function animal(kind) {
    ...
    else if(birdLike){cone(C,[0,.89,.52],[.14,.26,.14]).rotation.x=Math.PI/2;for(const x of [-.35,.35])sphere(color,[x,.54,0],[.14,.27,.39]);for(const x of [-.14,.14]){rod([x,.22,0],[x,.05,.15],.04,C);for(const dx of [-.08,.08])rod([x,.05,.15],[x+dx,.045,.28],.025,C);}if(kind==='hen')for(let n=0;n<3;n++)sphere(P,[0,1.23,.02+n*.12],[.08,.13,.09]);}
