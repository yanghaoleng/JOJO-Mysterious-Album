...
export const COMPONENTS = [
  ...
  {id:'ui:word-play',kind:'ui',name:'开口造世界 · 年龄与冒险界面',description:'在 /dev/words.html 体验全屏 3D、圆形转场、年龄步进器、单卡推荐、英文女声示范和点词创作。仅本小游戏拒绝中文表达。',source:'dev/words.js',capabilities:['年龄推荐与加减音效回弹','Calligraph 数字与字幕','常驻点词菜单与飞入字幕','语音文字上方居中继续与柔光输入','上一关与全新开始','持续收音与整句重读','DOMI语音欢迎与跳过','英文语音与点词','图标库对勾与作品分享'],dependencies:['ui:voice','ui:word-text','ui:word-music','logic:word-welcome','logic:session']},
