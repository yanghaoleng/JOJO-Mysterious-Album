...
export const COMPONENTS = [
  ...
  {id:'ui:word-play',kind:'ui',name:'开口造世界 · 年龄与冒险界面',description:'在 /dev/words.html 体验全屏 3D、圆形转场、年龄步进器、单卡推荐、英文女声示范和点词创作。仅本小游戏拒绝中文表达。',source:'dev/words.js',capabilities:['年龄推荐与加减音效回弹','Calligraph 数字与字幕','常驻点词菜单与飞入字幕','语音文字上方居中继续与柔光输入','上一关与全新开始','持续收音','DOMI语音欢迎与跳过','英文语音与点词','图标库对勾与作品分享'],dependencies:['ui:voice','ui:word-text','ui:word-music','logic:word-welcome','logic:session']},
  ...
  {id:'logic:word-welcome',kind:'logic',name:'DOMI 欢迎介绍',description:'在 /dev/words 初次进入，DOMI 使用童声询问昵称和年龄，例句切换温柔女声，完成介绍后提供开始入口，跳过回到年龄选择；昵称只留在内存。',source:'dev/word-welcome.js',capabilities:['英文昵称与年龄提取','3至10岁','跳过与清理'],dependencies:[]},
  ...
  {id:'ui:word-text',kind:'ui',name:'英语冒险 · 动态数字与字幕',description:'在 /dev/words.html 操作年龄加减体验 Calligraph Slots；在每轮观看 Text 发散提示与可替换词彩虹虚线。MohrRounded Bold，遵守减少动态效果设置。',source:'dev/presentation/word-text.jsx',capabilities:['Slots 年龄数字','Text 词语切换','真实时间戳逐词高亮','彩虹虚线单词每12秒轮换与点按替换','减少动态效果','卸载清理'],dependencies:[]},
