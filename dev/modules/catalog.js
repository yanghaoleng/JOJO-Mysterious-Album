...
export const COMPONENTS = [
  ...
  {id:'story:words',kind:'story',name:'独立章节 · 开口造世界',description:'选具体年龄后只推荐一章，九章各六轮，中文引出单个名词、第二个名词、数量、颜色、大小与最后一句话；中秋独立章节直达。实际入口 /dev/words.html。',source:'dev/content/word-games.js',capabilities:['三个年龄档','九章162轮与中秋独立章节','中文问答与渐进短语','第三步彩虹换词教学','目标词与知识点','开放例句','海底、露营与冰雪主题','12款扩展名词模型','13款常见动物与完整十二生肖'],dependencies:['logic:word-progress','logic:word-intent']},
