...
export const COMPONENTS = [
  ...
  {id:'ui:word-play',kind:'ui',name:'开口造世界 · 年龄与冒险界面',description:'在 /dev/words.html 体验全屏 3D、圆形转场、年龄步进器、单卡推荐、英文女声示范和点词创作。仅本小游戏拒绝中文表达。',source:'dev/words.js',capabilities:['年龄推荐与加减音效回弹','Calligraph 数字与字幕','英文语音与点词','作品图片与链接'],dependencies:['ui:voice','ui:word-text','logic:session']},
  {id:'ui:word-text',kind:'ui',name:'英语冒险 · 动态数字与字幕',description:'在 /dev/words.html 操作年龄加减体验 Calligraph Slots；进入第二轮起观看 Text 发散提示。MohrRounded Bold，遵守减少动态效果设置。',source:'dev/presentation/word-text.jsx',capabilities:['Slots 年龄数字','Text 词语切换','真实时间戳逐词高亮','减少动态效果','卸载清理'],dependencies:[]},
  {id:'logic:word-progress',kind:'logic',name:'英语逐词与开放表达进度',description:'累计完整句子的单词覆盖，填空逐步减少提示，自由表达保留孩子点子；只识别词，不评价发音。',source:'dev/word-progress.js',capabilities:['逐词累计','整句输入','创作替换'],dependencies:[]},
  ...
  {id:'logic:word-effects',kind:'logic',name:'所有物件的生长与动作',description:'花和便便都能生长、跳、飞、游、变长或表达心情，身体部件可装配。验证入口 dev/tools/verify-word-game.mjs。',source:'dev/presentation/word-effects.js',capabilities:['点名跳两下与落入盒子','生长与缩小','跳跃飞行游泳','情绪','部件装配','存档恢复'],dependencies:['logic:presenter']},
