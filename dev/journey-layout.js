...
export function makeDecorationLayout(worldId, { seed, steps }) {
  ...
  const kinds = worldId === 'word-snowfield' ? ['stone'] : worldId === 'reef' ? ['seaweed', 'coral', 'stone'] : worldId === 'cloud' ? ['cloud', 'flower', 'stone'] : worldId === 'observatory' ? ['star', 'stone', 'grass'] : ['flower', 'grass', 'stone', 'bush'];
