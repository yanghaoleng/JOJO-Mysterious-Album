...
function reduce(state, c, context) {
  ...
  if (c.type === "entity.spawn") {
    ...
    if (c.type === 'entity.effect') {
      ...
      if(c.effect==='stop') {delete entity.effects.gesture; delete entity.effects.altitude; delete entity.effects.symbol; delete entity.effects.luminance; if(entity.effects.emotion==='sleepy')delete entity.effects.emotion;}
    }
