...
豆豆、登月和回声三线各三章六幕；第一束好奇光六章42幕，复用原版故事脚本，手电、收音机、颜色罐分别在第一章第2、4、9幕出现；《等一个肚子的回答》为第一章改编的单章11幕独立故事，沿用同款语音推进与道具收集。语音自动推进；每幕只问一个行动。可暂停麦克风、跳过正在说的句子，也可展开触摸选项或输入文字。低龄线用三个短选择认识伙伴；月线不加开场问卷。每幕自动保存进度，重新打开可继续。
